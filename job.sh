...
python ./experiments/smnist/smnist_train_alif_tbptt_phase_delta.py --delta-base-threshold 0.35 --delta-wave-amplitude 0.2 --delta-wave-frequency 56 --oscillate-threshold --negative-at-trough